...
Good investigation boundaries include behavior and call flow, architecture and ownership, data or lifecycle contracts, tests and verification, security or authority, and release compatibility—but include only those the objective actually needs.
...
Your output is evidence for plan synthesis. It grants no authority to edit or execute a change.`,
  rules: `${COMMON_RULES}
...
Do not edit files, execute mutation commands, produce a final implementation plan, or investigate out-of-scope focuses.`,
